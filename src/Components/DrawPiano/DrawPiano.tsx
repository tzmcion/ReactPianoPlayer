...
export default function DrawPiano({Data,Speed}:DrawPianoProps):ReactElement {
    ...
    return (
        <div className='Piano' style={{height: windowHeight}}>
            <Tracks Width={WhiteKeyWidth * 52} Height={windowHeight-215 + 15} Speed={10} Data={Data!} BlackNumbers={blackKeysNumbers()} KeysPositions={KeysPositions()} intervalSpeed={Speed} />
